...
function makeProfilePage(stage) {
    ...
    var username_textArea = new TextArea({height:60, placeholder:"user name"}).pos(0, 120,CENTER,TOP, page);
    var email_textArea = new TextArea({height:60, placeholder:"email"}).pos(0, 180,CENTER,TOP, page);
